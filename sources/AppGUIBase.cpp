...
AppGUIBase::AppGUIBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	mask_color_picker = new wxColourPickerCtrl( this, wxID_ANY, *wxBLACK, wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_SHOW_LABEL );
	...
	alpha_label = new wxStaticText( this, wxID_ANY, wxT("Poziom kanału alfa"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
	alpha_label->Wrap( -1 );
	...
	alpha_level_slider->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( AppGUIBase::changeAlphaLevel ), NULL, this );
	alpha_level_slider->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( AppGUIBase::changeAlphaLevel ), NULL, this );
...
{
	// Disconnect Events
	read_img_button->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( AppGUIBase::readImgPath ), NULL, this );
	...
	alpha_level_slider->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( AppGUIBase::changeAlphaLevel ), NULL, this );
	alpha_level_slider->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( AppGUIBase::changeAlphaLevel ), NULL, this );
	alpha_level_slider->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( AppGUIBase::changeAlphaLevel ), NULL, this );
	alpha_level_slider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( AppGUIBase::changeAlphaLevel ), NULL, this );
